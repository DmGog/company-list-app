...
export const companiesData: Company[] = [
  ...
  },
  {
    id: v4(),
    name: 'БудИмпекс',
    address: { country: 'Россия', city: 'Красноярск', street: 'Тверская', houseNumber: '5' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ТехПромСтрой',
    address: { country: 'Беларусь', city: 'Минск', street: 'Каменногорская', houseNumber: '2' },
    selected: false,
  },
  {
    id: v4(),
    name: 'СтройКонтракт',
    address: { country: 'Казахстан', city: 'Алматы', street: 'Шевченко', houseNumber: '25' },
    selected: false,
  },
  {
    id: v4(),
    name: 'РеконСтрой',
    address: { country: 'Россия', city: 'Омск', street: 'Зеленая', houseNumber: '1' },
    selected: false,
  },
  {
    id: v4(),
    name: 'НовоСтрой',
    address: { country: 'Беларусь', city: 'Гомель', street: 'Ленина', houseNumber: '33' },
    selected: false,
  },
  {
    id: v4(),
    name: 'КлассСтрой',
    address: { country: 'Россия', city: 'Тула', street: 'Центральная', houseNumber: '14' },
    selected: false,
  },
  {
    id: v4(),
    name: 'Мегабуд',
    address: { country: 'Казахстан', city: 'Шымкент', street: 'Тимурова', houseNumber: '9' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ТехСтрой',
    address: { country: 'Россия', city: 'Владивосток', street: 'Партизанская', houseNumber: '11' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ГорСтрой',
    address: { country: 'Казахстан', city: 'Тараз', street: 'Чайковского', houseNumber: '15' },
    selected: false,
  },
  {
    id: v4(),
    name: 'АкваСтрой',
    address: { country: 'Беларусь', city: 'Бобруйск', street: 'Молодежная', houseNumber: '20' },
    selected: false,
  },
  {
    id: v4(),
    name: 'РеалСтрой',
    address: { country: 'Россия', city: 'Рязань', street: 'Пролетарская', houseNumber: '4' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ДивСтрой',
    address: { country: 'Казахстан', city: 'Костанай', street: 'Ленинградская', houseNumber: '18' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ДомСтрой',
    address: { country: 'Беларусь', city: 'Могилев', street: 'Промышленная', houseNumber: '12' },
    selected: false,
  },
  {
    id: v4(),
    name: 'МеталлСтрой',
    address: { country: 'Казахстан', city: 'Алматы', street: 'Достык', houseNumber: '31' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ВостокСтрой',
    address: { country: 'Россия', city: 'Новосибирск', street: 'Советская', houseNumber: '16' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ГруппаСтрой',
    address: { country: 'Беларусь', city: 'Гомель', street: 'Советская', houseNumber: '7' },
    selected: false,
  },
  {
    id: v4(),
    name: 'СтройПартнер',
    address: { country: 'Казахстан', city: 'Актау', street: 'Казахстанская', houseNumber: '19' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ПрогрессСтрой',
    address: { country: 'Россия', city: 'Томск', street: 'Челюскинцев', houseNumber: '10' },
    selected: false,
  },
  {
    id: v4(),
    name: 'ЭнергияСтрой',
    address: { country: 'Беларусь', city: 'Минск', street: 'Пушкина', houseNumber: '22' },
    selected: false,
  },
];
